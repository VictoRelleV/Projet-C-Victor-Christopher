...
public:
    ...
    shootingguard(string nom, string prenom, int OVR, string position, string team, string imagePath)
        : joueur(nom, prenom, OVR, position, team, imagePath)
    {
        ...
        uniform_int_distribution<> distribution2(25, 50);
        uniform_int_distribution<> distribution3(90, 100);
