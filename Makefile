...
SOURCES = main.cc joueur.cc match.cc fonctions.cc question.cc lib/basketball/src/Solid.cpp lib/basketball/src/Net.cpp lib/basketball/src/Ball.cpp lib/basketball/src/Game.cpp
