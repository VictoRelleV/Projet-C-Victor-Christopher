...
SOURCES = main.cc Center.cc Joueur.cc match.cc fonctions.cc question.cc clickablelabel.cc headcoach.cc lib/basketball/src/Solid.cpp lib/basketball/src/Net.cpp lib/basketball/src/Ball.cpp lib/basketball/src/Game.cpp
